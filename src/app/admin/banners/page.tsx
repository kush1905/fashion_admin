      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {banners.map((b) => (
          <Card key={b.id} className="overflow-hidden">
            <img src={b.desktopImage} alt="" className="h-40 w-full object-cover" />
            <div className="p-4">
              ...
              <div className="mt-3 flex gap-2">
                <img src={b.tabletImage} alt="" className="h-16 w-20 rounded object-cover" />
                <img src={b.mobileImage} alt="" className="h-16 w-12 rounded object-cover" />
              </div>
        ...
        <DialogContent>
          ...
          {form ? (
            <div className="mt-4 grid max-h-[70vh] gap-3 overflow-y-auto">
              ...
              <Button onClick={async () => { await save(form); toast.success("Banner saved"); setOpen(false); }}>Save</Button>
            </div>
          ) : null}
        </DialogContent>
      </Dialog>

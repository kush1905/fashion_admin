  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[min(92vw,560px)] -translate-x-1/2 -translate-y-1/2 rounded-xl border bg-card p-5 shadow-xl",
          className,
        )}
        {...props}
      >
  ...
  return (
    <SheetPrimitive.Portal>
      ...
      <SheetPrimitive.Content
        className={cn(
          "fixed z-50 flex h-full w-[min(92vw,420px)] flex-col border-border bg-card shadow-xl",
  ...
  return (
    <AlertDialogPrimitive.Portal>
      ...
      <AlertDialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[min(92vw,440px)] -translate-x-1/2 -translate-y-1/2 rounded-xl border bg-card p-5 shadow-xl",
          className,
        )}
        {...props}
      >
